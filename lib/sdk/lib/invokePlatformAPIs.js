...
var { makeHttpCall, makeHttpCallGet } = require("../../../makeHttpCall");
...
function makeRequestGet(url, method, body, opts) {
    var botId = url.split("/")[6];
    var headers;
    opts    = opts || {};
    headers = opts.headers || {};
